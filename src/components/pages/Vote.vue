      ...
      <main style="opacity: 1" class="">
        <div class="static">
          <p
            ...
            class="js-subheading"
          >
            Experimental team line-up and football field using CSS 3D
            transforms.
          </p>
          <div
            style="
              ...
              transform: translateX(0px) translateY(0px);
            "
            class="js-switcher switcher"
          >
            <a href="#" class="js-switch disabled switch-btn">HOME</a
            ><a href="#" class="js-switch switch-btn">AWAY</a>
          </div>
        </div>
          ...
          >
            <div class="terrain js-terrain">
              ...
              <div class="field ground">
                ...
                >
                  <div class="defence">
                    <img src="@/assets/images/field/img.jpg" />
                    <img src="@/assets/images/field/img.jpg" />
                    <img src="@/assets/images/field/img.jpg" />
                    <img src="@/assets/images/field/img.jpg" />
                  </div>
                ...
                <div
                  class="
                    field__line field__line--penalty field__line--penalty--far
                  "
                >
                  <div class="goolkeeper">
                    <img src="@/assets/images/field/img.jpg" />
                  </div>
                </div>
              </div>
...
.vote_page {
  * {
  ...
  .world.switched {
    -webkit-transform: translateZ(250px) rotateY(30deg) translateX(60px)
      translateY(-200px);
    transform: translateZ(250px) rotateY(30deg) translateX(60px)
      translateY(-200px);
  }
  .switch-btn {
