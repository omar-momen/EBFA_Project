...
export default {
  ...
  computed: {
    // playground() {
    //   return this.lang == "ar" ? "افضل ملعب" : "Best Playground";
    // },
    // underage() {
    //   return this.lang == "ar" ? "افضل صاعد" : "Best Underage";
    // },
    // stranger() {
    //   return this.lang == "ar" ? "افضل اجنبي" : "Best Foreign";
    // },
    // professional() {
    //   return this.lang == "ar" ? "افضل محترف" : "Best Professional";
    // },
    // bestPlayer() {
    //   return this.lang == "ar" ? "افضل لاعب" : "Best Player";
    // },
  },
};
</script>
